...
from userbot.utils import phantom_cmd, humanbytes, progress, time_formatter
import subprocess
import patoolib
import tarfile
...
@borg.on(phantom_cmd(pattern=("rar ?(.*)")))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(phantom_cmd(pattern=("7z ?(.*)")))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(phantom_cmd(pattern=("tar ?(.*)")))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@borg.on(phantom_cmd(pattern="unzip"))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.edit("Processing ...")
...
@borg.on(phantom_cmd(pattern="unrar"))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.edit("Processing ...")
...
@borg.on(phantom_cmd(pattern="untar"))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.edit("Processing ...")
